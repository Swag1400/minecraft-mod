...
public class FontRenderUtils {
        ...
        public FontRenderUtils(final ExecutorService executorService, final ConcurrentLinkedQueue<TextureData> textureQueue, final Font font) {
            this(executorService, textureQueue, font, 256);
        }

        public FontRenderUtils(final ExecutorService executorService, final ConcurrentLinkedQueue<TextureData> textureQueue, final Font font, final int characterCount) {
            this(executorService, textureQueue, font, characterCount, true);
        }

        public FontRenderUtils(final ExecutorService executorService, final ConcurrentLinkedQueue<TextureData> textureQueue, final Font font, final boolean antiAlias) {
            this(executorService, textureQueue, font, 256, antiAlias);
        }

        public FontRenderUtils(final ExecutorService executorService, final ConcurrentLinkedQueue<TextureData> textureQueue, final Font font, final int characterCount, final boolean antiAlias) {
            ...
            for (int i = 0; i < length; ++i) {
                ...
                if (previous != '§') {
                    if (character == '§' && i < length) {
                        ...
                        if (obfuscated) {
                            character += (char)FontRenderUtils.RANDOM_OFFSET;
                        }
        ...
        static {
            FontRenderUtils.RANDOM_OFFSET = 1;
        }
