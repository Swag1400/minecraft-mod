...
public final class CalculatorSubtract extends Command
{
    public CalculatorSubtract()
    {
        super(new String[] {"calcsub","csub","calculatorsubtract"}, new Argument("x"), new Argument("y"));
    }
