...
public class BlockLever extends Block
{
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        ...
        {
            return var9.withProperty(FACING, BlockLever.EnumOrientation.func_176856_a(facing, placer.getDirectionFacing()));
        }
        else
        {
            ...
            do
            {
                if (!var10.hasNext())
                {
                    ...
                    {
                        return var9.withProperty(FACING, BlockLever.EnumOrientation.func_176856_a(EnumFacing.UP, placer.getDirectionFacing()));
                    }
            ...
            return var9.withProperty(FACING, BlockLever.EnumOrientation.func_176856_a(var11, placer.getDirectionFacing()));
        }
    }
