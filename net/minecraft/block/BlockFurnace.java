...
public class BlockFurnace extends BlockContainer
{
    ...
    {
        return this.getDefaultState().withProperty(FACING, placer.getDirectionFacing().getOpposite());
    }

    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        worldIn.setBlockState(pos, state.withProperty(FACING, placer.getDirectionFacing().getOpposite()), 2);
