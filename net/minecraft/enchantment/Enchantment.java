...
{
    public static final Enchantment[] ENCHANTMENTS = new Enchantment[256];
    public static final Enchantment[] ENCHANTMENTS_LIST;
    private static final Map OBJECT_HASH_MAP = Maps.newHashMap();
    ...
    {
        return p_180306_0_ >= 0 && p_180306_0_ < ENCHANTMENTS.length ? ENCHANTMENTS[p_180306_0_] : null;
    }
    ...
    protected Enchantment(int p_i45771_1_, ResourceLocation p_i45771_2_, int p_i45771_3_, EnumEnchantmentType p_i45771_4_)
    {
        ...
        if (ENCHANTMENTS[p_i45771_1_] != null)
        {
            throw new IllegalArgumentException("Duplicate enchantment id!");
        }
        else
        {
            ENCHANTMENTS[p_i45771_1_] = this;
            OBJECT_HASH_MAP.put(p_i45771_2_, this);
        }
    }

    public static Enchantment func_180305_b(String p_180305_0_)
    {
        return (Enchantment) OBJECT_HASH_MAP.get(new ResourceLocation(p_180305_0_));
    }

    public static String[] func_180304_c()
    {
        String[] var0 = new String[OBJECT_HASH_MAP.size()];
        int var1 = 0;
        ResourceLocation var3;

        for (Iterator var2 = OBJECT_HASH_MAP.keySet().iterator(); var2.hasNext(); var0[var1++] = var3.toString())
        {
    ...
    static
    {
        ...
        ENCHANTMENTS_LIST = (Enchantment[]) var0.toArray(new Enchantment[var0.size()]);
    }
}
