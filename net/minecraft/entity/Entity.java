...
public abstract class Entity implements ICommandSender
{
    ...
    protected void setSize(float width, float height)
    {
        if (width != this.width || height != this.height)
        {
            ...
            this.width = width;
            this.height = height;
            this.setBoundingBox(new AxisAlignedBB(this.getEntityBoundingBox().minX, this.getEntityBoundingBox().minY, this.getEntityBoundingBox().minZ, this.getEntityBoundingBox().minX + (double) this.width, this.getEntityBoundingBox().minY + (double) this.height, this.getEntityBoundingBox().minZ + (double) this.width));
    ...
    public void setPosition(double x, double y, double z)
    {
        ...
        this.setBoundingBox(new AxisAlignedBB(x - (double) var7, y, z - (double) var7, x + (double) var7, y + (double) var8, z + (double) var7));
    }
    ...
    {
        MovePlayerEvent movePlayerEvent = new MovePlayerEvent(x, y, z);

        if (this instanceof EntityPlayerSP)
        {
            Gun.getInstance().getEventManager().dispatch(movePlayerEvent);
            x = movePlayerEvent.getMotionX();
            y = movePlayerEvent.getMotionY();
            z = movePlayerEvent.getMotionZ();
        }
        ...
        if (this.noClip)
        {
            this.setBoundingBox(this.getEntityBoundingBox().offset(x, y, z));
            this.func_174829_m();
        }
        else
        {
            ...
            double var15 = y;
            double var17 = z;
            boolean var19 = this.onGround && movePlayerEvent.isSafe() && this instanceof EntityPlayer;
            ...
            this.setBoundingBox(this.getEntityBoundingBox().offset(0.0D, y, 0.0D));
            ...
            this.setBoundingBox(this.getEntityBoundingBox().offset(x, 0.0D, 0.0D));
            ...
            this.setBoundingBox(this.getEntityBoundingBox().offset(0.0D, 0.0D, z));
            StepEvent stepEvent = new StepEvent(stepHeight);

            if (this instanceof EntityPlayerSP)
            {
                Gun.getInstance().getEventManager().dispatch(stepEvent);
            }
            ...
            if (this instanceof EntityPlayerSP)
            {
                Gun.getInstance().getEventManager().dispatch(new StepEvent(StepEvent.Time.AFTER));
            }
            ...
            AirBobbingEvent airBobbingEvent = new AirBobbingEvent();
            Gun.getInstance().getEventManager().dispatch(airBobbingEvent);
            this.onGround = airBobbingEvent.isCancelled() || this.isCollidedVertically && var15 < 0.0D;
