...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleTimeUpdate(S03PacketTimeUpdate packetIn) {
        PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
        this.gameController.theWorld.func_82738_a(packetIn.getTotalWorldTime());
    ...
    public void handleExplosion(S27PacketExplosion packetIn) {
        PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
        Explosion var2 = new Explosion(this.gameController.theWorld, (Entity) null, packetIn.getMotionX(), packetIn.getMotionY(), packetIn.getMotionZ(), packetIn.func_149146_i(), packetIn.func_149150_j());
    ...
    public void handleSignEditorOpen(S36PacketSignEditorOpen packetIn) {
        ...
        SignEvent signEvent = new SignEvent((TileEntitySign) var2);
        Gun.getInstance().getEventManager().dispatch(signEvent);
