...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float p_175180_1_)
    {
        ...
        {
            RenderGameOverlayEvent renderGameOverlayEvent1 = new RenderGameOverlayEvent(RenderGameOverlayEvent.Type.PUMPKIN);
            Gun.getInstance().getEventManager().dispatch(renderGameOverlayEvent1);

            if (!renderGameOverlayEvent1.isRenderPumpkin())
            {
        ...
        RenderGameInfoEvent renderGameInfoEvent = new RenderGameInfoEvent(var2);

        if (this.mc.playerController.shouldDrawHUD())
        {
            //TODO custom bars
            this.func_180477_d(var2);
            Gun.getInstance().getEventManager().dispatch(renderGameInfoEvent);
        }
        ...
        RenderGameOverlayEvent renderGameOverlayEvent = new RenderGameOverlayEvent(RenderGameOverlayEvent.Type.GUI);
...
//        Gun.getInstance().getEventManager().dispatch(event);
        ...
        Property<Boolean> notificationProperty = render.getPropertyByAlias("Notifications");
        if (notificationProperty.getValue()) {
        ...
        GlStateManager.enableAlpha();
        Gun.getInstance().getEventManager().dispatch(new RenderGameOverlayEvent(var2));
    }
    ...
    protected boolean func_175183_b()
    {
        ...
        else if (this.mc.playerController.enableEverythingIsScrewedUpMode())
        {
            ...
            else
            {
                ...
                {
                    BlockPos var1 = this.mc.objectMouseOver.getPos();
    ...
    private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        while (var12.hasNext())
        {
            ...
            if (var11 == var21.size())
            {
            	  if (((ToggleableModule) Gun.getInstance().getModuleManager().getModuleByAlias("antihcf")).isRunning() && org.apache.commons.lang3.StringUtils.containsIgnoreCase((CharSequence)var15, (CharSequence)"VeltPVP") && org.apache.commons.lang3.StringUtils.containsIgnoreCase((CharSequence)var15, (CharSequence)"ArcaneHCF") && org.apache.commons.lang3.StringUtils.containsIgnoreCase((CharSequence)var15, (CharSequence)"FaithfulMC") && org.apache.commons.lang3.StringUtils.containsIgnoreCase((CharSequence)var15, (CharSequence)"HCNations")&& org.apache.commons.lang3.StringUtils.containsIgnoreCase((CharSequence)var15, (CharSequence)"Voration") && org.apache.commons.lang3.StringUtils.containsIgnoreCase((CharSequence)var15, (CharSequence)"Holy"))
                  {
            	        var15 = var15.replaceAll("(?i)VeltPVP", String.valueOf("§b") + "Gun.cc§r");
            	        var15 = var15.replaceAll("(?i)ArcaneHCF", String.valueOf("§b") + "Gun.cc§r");
            	        var15 = var15.replaceAll("(?i)FaithfulMC", String.valueOf("§b") + "Gun.cc§r");
            	        var15 = var15.replaceAll("(?i)HCNations", String.valueOf("§b") + "Gun.cc§r");
            	        var15 = var15.replaceAll("(?i)Voration", String.valueOf("§b") + "Gun.cc§r");
            	        var15 = var15.replaceAll("(?i)Holy", String.valueOf("§b") + "Gun.cc§r");
    ...
    private void func_180477_d(ScaledResolution p_180477_1_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            int var21 = -1;
            Render render = (Render) Gun.getInstance().getModuleManager().getModuleByAlias("render");
            Property<Boolean> customHUD = render.getPropertyByAlias("CustomBars");

            if (render == null || customHUD == null || !customHUD.getValue())
            {
                if (var2.isPotionActive(Potion.regeneration))
                {
                    var21 = this.updateCounter % MathHelper.ceiling_float_int(var14 + 5F);
                }
            }
    ...
    private void func_175184_a(int p_175184_1_, int p_175184_2_, int p_175184_3_, float p_175184_4_, EntityPlayer p_175184_5_)
    {
        ...
        if (var6 != null)
        {
            ...
            this.itemRenderer.renderItemOverlays(this.mc.fontRenderer, var6, p_175184_2_, p_175184_3_);
        }
    }
