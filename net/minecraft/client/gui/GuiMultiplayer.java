...
import me.comu.client.gui.screens.accountmanager.GuiDirectLogin;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(69, this.width / 2 + 158, this.height - 52, 73, 20, "Login"));
        this.buttonList.add(new GuiButton(420, this.width / 2 + 158, this.height - 28, 73, 20, "Accounts"));
