...
public class GuiOverlayDebug extends Gui
{
    ...
    protected void func_180798_a()
    {
        ...
        for (int var2 = 0; var2 < var1.size(); ++var2)
        {
            ...
            if (!Strings.isNullOrEmpty(var3))
            {
                ...
                this.fontRenderer.drawStringWithShadow(var3, 2, var7, 14737632);
            }
        }
    }
    ...
    protected void func_175239_b(ScaledResolution p_175239_1_)
    {
        ...
        for (int var3 = 0; var3 < var2.size(); ++var3)
        {
            ...
            if (!Strings.isNullOrEmpty(var4))
            {
                ...
                this.fontRenderer.drawStringWithShadow(var4, var7, var8, 14737632);
            }
        }
    }
    ...
    protected List call()
    {
        ...
        {
            return Lists.newArrayList(new String[] {"Exeter (" + this.mc.func_175600_c() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities(), this.mc.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", new Object[]{Integer.valueOf(var1.getX() & 15), Integer.valueOf(var1.getY() & 15), Integer.valueOf(var1.getZ() & 15)})});
        }
        else
        {
            Entity var2 = this.mc.getRenderViewEntity();
            EnumFacing var3 = var2.getDirectionFacing();
            String var4 = "Invalid";
            ...
            ArrayList var5 = Lists.newArrayList(new String[] {"FPS: " + this.mc.debug.split(" ")[0],
                            String.format("XYZ: %s, %s, %s", new Object[]{(int) this.mc.getRenderViewEntity().posX,
                            (int) this.mc.getRenderViewEntity().getEntityBoundingBox().minY, (int) this.mc.getRenderViewEntity().posZ}), String.format("Chunk: %d %d %d in %d %d %d",
                             new Object[]{Integer.valueOf(var1.getX() & 15), Integer.valueOf(var1.getY() & 15), Integer.valueOf(var1.getZ() & 15), Integer.valueOf(var1.getX() >> 4),
                            Integer.valueOf(var1.getY() >> 4), Integer.valueOf(var1.getZ() >> 4)}), String.format("Facing: %s", new Object[]{var3.toString().toUpperCase()}),
                            String.format("World: %s", new Object[]{mc.theWorld.provider.getDimensionName()})});
            ...
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getPos() != null)
            {
                BlockPos var91 = this.mc.objectMouseOver.getPos();
    ...
    protected List func_175238_c()
    {
        ...
        long var7 = var3 - var5;
        ArrayList var9 = Lists.newArrayList(new String[] {String.format("Memory:% 2d%% %03d/%03dMB", new Object[]{Long.valueOf(var7 * 100L / var1), Long.valueOf(func_175240_a(var7)), Long.valueOf(func_175240_a(var1))}), String.format("Allocated:% 2d%% %03dMB", new Object[]{Long.valueOf(var3 * 100L / var1), Long.valueOf(func_175240_a(var3))})});
        ...
        else
        {
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getPos() != null)
            {
                BlockPos var10 = this.mc.objectMouseOver.getPos();
