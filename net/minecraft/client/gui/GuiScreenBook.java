    ...
    private void sendBookToServer(boolean p_146462_1_) throws IOException
    {
        if (this.bookIsUnsigned && this.bookIsModified)
        {
            if (this.bookPages != null)
            {
                ...
                this.mc.func_175102_a().addToSendQueue(new C17PacketCustomPayload(var2, var7));
            }
        }
    }
    ...
    public IChatComponent func_175385_b(int p_175385_1_, int p_175385_2_)
    {
        ...
        else
        {
            ...
            if (var3 >= 0 && var4 >= 0)
            {
                ...
                if (var3 <= 116 && var4 < this.mc.fontRenderer.FONT_HEIGHT * var5 + var5)
                {
                    int var6 = var4 / this.mc.fontRenderer.FONT_HEIGHT;
                    ...
                    if (var6 >= 0 && var6 < this.field_175386_A.size())
                    {
                        ...
                        while (var9.hasNext())
                        {
                            ...
                            {
                                var8 += this.mc.fontRenderer.getStringWidth(((ChatComponentText) var10).getChatComponentText_TextValue());
