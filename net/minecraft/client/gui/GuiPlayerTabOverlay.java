...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void func_175249_a(int p_175249_1_, Scoreboard p_175249_2_, ScoreObjective p_175249_3_)
    {
        ...
        while (var8.hasNext())
        {
            ...
            var10 = this.field_175250_f.fontRenderer.getStringWidth(this.func_175243_a(var9));
            var6 = Math.max(var6, var10);

            if (p_175249_3_ != null && p_175249_3_.func_178766_e() != IScoreObjectiveCriteria.EnumRenderType.HEARTS)
            {
                var10 = this.field_175250_f.fontRenderer.getStringWidth(" " + p_175249_2_.getValueFromObjective(var9.func_178845_a().getName(), p_175249_3_).getScorePoints());
        ...
        boolean var11 = this.field_175250_f.isIntegratedServerRunning() || this.field_175250_f.func_175102_a().getNetworkManager().func_179292_f();
        int var12;
        ...
        if (this.header != null)
        {
            var17 = this.field_175250_f.fontRenderer.listFormattedStringToWidth(this.header.getFormattedText(), p_175249_1_ - 50);

            for (var19 = var17.iterator(); var19.hasNext(); var16 = Math.max(var16, this.field_175250_f.fontRenderer.getStringWidth(var20)))
            {
        ...
        if (this.footer != null)
        {
            var18 = this.field_175250_f.fontRenderer.listFormattedStringToWidth(this.footer.getFormattedText(), p_175249_1_ - 50);

            for (var19 = var18.iterator(); var19.hasNext(); var16 = Math.max(var16, this.field_175250_f.fontRenderer.getStringWidth(var20)))
            {
                var20 = (String) var19.next();
            }
        }
        ...
        if (var17 != null)
        {
            drawRect(p_175249_1_ / 2 - var16 / 2 - 1, var15 - 1, p_175249_1_ / 2 + var16 / 2 + 1, var15 + var17.size() * this.field_175250_f.fontRenderer.FONT_HEIGHT, Integer.MIN_VALUE);

            for (var19 = var17.iterator(); var19.hasNext(); var15 += this.field_175250_f.fontRenderer.FONT_HEIGHT)
            {
                var20 = (String) var19.next();
                var21 = this.field_175250_f.fontRenderer.getStringWidth(var20);
                this.field_175250_f.fontRenderer.drawStringWithShadow(var20, (float)(p_175249_1_ / 2 - var21 / 2), (float) var15, -1);
            }
        ...
        for (int var30 = 0; var30 < var28; ++var30)
        {
            ...
            if (var30 < var5.size())
            {
                ...
                if (var24.getGameType() == WorldSettings.GameType.SPECTATOR)
                {
                    ...
                    this.field_175250_f.fontRenderer.drawStringWithShadow(var25, (float) var22, (float) var23, -1862270977);
                }
                else
                {
                    this.field_175250_f.fontRenderer.drawStringWithShadow(var25, (float) var22, (float) var23, -1);
                }
        ...
        {
            var15 += var29 * 9 + 1;
            drawRect(p_175249_1_ / 2 - var16 / 2 - 1, var15 - 1, p_175249_1_ / 2 + var16 / 2 + 1, var15 + var18.size() * this.field_175250_f.fontRenderer.FONT_HEIGHT, Integer.MIN_VALUE);

            for (var19 = var18.iterator(); var19.hasNext(); var15 += this.field_175250_f.fontRenderer.FONT_HEIGHT)
            {
                var20 = (String) var19.next();
                var21 = this.field_175250_f.fontRenderer.getStringWidth(var20);
                this.field_175250_f.fontRenderer.drawStringWithShadow(var20, (float)(p_175249_1_ / 2 - var21 / 2), (float) var15, -1);
    ...
    private void func_175247_a(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo p_175247_6_)
    {
        ...
        if (p_175247_1_.func_178766_e() == IScoreObjectiveCriteria.EnumRenderType.HEARTS)
        {
            ...
            if (var8 > 0)
            {
                ...
                else
                {
                    ...
                    if (p_175247_5_ - this.field_175250_f.fontRenderer.getStringWidth(var14 + "hp") >= p_175247_4_)
                    {
                        var14 = var14 + "hp";
                    }

                    this.field_175250_f.fontRenderer.drawStringWithShadow(var14, (float)((p_175247_5_ + p_175247_4_) / 2 - this.field_175250_f.fontRenderer.getStringWidth(var14) / 2), (float) p_175247_2_, var13);
                }
            }
        }
        else
        {
            ...
            this.field_175250_f.fontRenderer.drawStringWithShadow(var15, (float)(p_175247_5_ - this.field_175250_f.fontRenderer.getStringWidth(var15)), (float) p_175247_2_, 16777215);
        }
    }
