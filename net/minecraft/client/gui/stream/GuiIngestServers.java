...
public class GuiIngestServers extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        Minecraft.getMinecraft().fontRenderer.drawString(mc.thePlayer.getName(), width - Minecraft.getMinecraft().fontRenderer.getStringWidth(mc.thePlayer.getName()) - 2, height - Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT - 2, 0xa0a0a0);
