...
public class GuiSpectator extends Gui implements ISpectatorMenuReciepient
{
    ...
    private void func_175266_a(int p_175266_1_, int p_175266_2_, float p_175266_3_, float p_175266_4_, ISpectatorMenuObject p_175266_5_)
    {
        ...
        if (p_175266_5_ != SpectatorMenu.field_178657_a)
        {
            ...
            {
                this.field_175268_g.fontRenderer.drawStringWithShadow(var8, (float)(p_175266_2_ + 19 - 2 - this.field_175268_g.fontRenderer.getStringWidth(var8)), p_175266_3_ + 6.0F + 3.0F, 16777215 + (var6 << 24));
            }
        }
    }
    ...
    public void func_175263_a(ScaledResolution p_175263_1_)
    {
        ...
        if (var2 > 3 && this.field_175271_i != null)
        {
            ...
            if (var4 != null)
            {
                int var5 = (p_175263_1_.getScaledWidth() - this.field_175268_g.fontRenderer.getStringWidth(var4)) / 2;
                int var6 = p_175263_1_.getScaledHeight() - 35;
                GlStateManager.pushMatrix();
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                this.field_175268_g.fontRenderer.drawStringWithShadow(var4, (float) var5, (float) var6, 16777215 + (var2 << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        }
