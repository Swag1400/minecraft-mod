...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    public GuiKeyBindingList(GuiControls p_i45031_1_, Minecraft mcIn)
    {
        ...
        for (int var8 = 0; var8 < var7; ++var8)
        {
            ...
            int var11 = mcIn.fontRenderer.getStringWidth(I18n.format(var9.getKeyDescription(), new Object[0]));
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
        {
            ...
            GuiKeyBindingList.this.mc.fontRenderer.drawString(this.field_148283_c, x + 90 - GuiKeyBindingList.this.maxListLabelWidth, y + slotHeight / 2 - GuiKeyBindingList.this.mc.fontRenderer.FONT_HEIGHT / 2, 16777215);
