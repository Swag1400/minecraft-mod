...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        //   Display.setTitle(Gun.TITLE + " Client b" + Gun.BUILD);
        new Gun();
    ...
    private void func_175609_am() throws LWJGLException {
        ...
        //   Display.setTitle("Loading Gun Client...");
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn == null && this.theWorld == null) {
            ...
            onDeathEvent event = new onDeathEvent();
            Gun.getInstance().getEventManager().dispatch(event);
    ...
    private void runGameLoop() throws IOException {
        ...
        for (int var3 = 0; var3 < this.timer.elapsedTicks; ++var3) {
            // Display.setTitle(Display.getTitle().substring(1, Display.getTitle().length()) + Display.getTitle().substring(0, 1));
            this.runTick();
        }
    ...
    private void displayDebugInfo(long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            var14 = 16777215;
            this.fontRenderer.drawStringWithShadow(var20, (float) (var8 - var7), (float) (var9 - var7 / 2 - 16), var14);
            this.fontRenderer.drawStringWithShadow(var20 = var19.format(var4.field_76330_b) + "%", (float) (var8 + var7 - this.fontRenderer.getStringWidth(var20)), (float) (var9 - var7 / 2 - 16), var14);
            ...
            for (int var21 = 0; var21 < var3.size(); ++var21) {
                ...
                this.fontRenderer.drawStringWithShadow(var23, (float) (var8 - var7), (float) (var9 + var7 / 2 + var21 * 8 + 20), var22.func_76329_a());
                this.fontRenderer.drawStringWithShadow(var23 = var19.format(var22.field_76332_a) + "%", (float) (var8 + var7 - 50 - this.fontRenderer.getStringWidth(var23)), (float) (var9 + var7 / 2 + var21 * 8 + 20), var22.func_76329_a());
                this.fontRenderer.drawStringWithShadow(var23 = var19.format(var22.field_76330_b) + "%", (float) (var8 + var7 - this.fontRenderer.getStringWidth(var23)), (float) (var9 + var7 / 2 + var21 * 8 + 20), var22.func_76329_a());
            }
        }
    }
    ...
    private void sendClickBlockToController(boolean leftClick) {
        ...
        if (this.leftClickCounter <= 0) {
            if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                BlockPos var2 = this.objectMouseOver.getPos();
    ...
    private void clickMouse() {
        Gun.getInstance().getEventManager().dispatch(new InputEvent(InputEvent.Type.MOUSE_LEFT_CLICK));
        ...
        if (this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (Minecraft.SwitchEnumMinecartType.field_152390_a[this.objectMouseOver.typeOfHit.ordinal()]) {
                    ...
                    case 2:
                        BlockPos var1 = this.objectMouseOver.getPos();
    ...
    private void rightClickMouse() {
        Gun.getInstance().getEventManager().dispatch(new InputEvent(InputEvent.Type.MOUSE_RIGHT_CLICK));
        ...
        if (this.objectMouseOver == null) {
            ...
            switch (Minecraft.SwitchEnumMinecartType.field_152390_a[this.objectMouseOver.typeOfHit.ordinal()]) {
                ...
                case 2:
                    BlockPos var3 = this.objectMouseOver.getPos();
    ...
    private void runTick() throws IOException {
        ...
        Gun.getInstance().getEventManager().dispatch(new TickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        Gun.getInstance().getEventManager().dispatch(new InputEvent(InputEvent.Type.KEYBOARD_KEY_PRESS));
            ...
            while (this.gameSettings.keyBindInventory.isPressed()) {
                if (this.playerController.isRidingHorse()) {
                    ...
                    this.func_175102_a().addToSendQueue(new C16PacketClientStatus(C16PacketClientStatus.EnumState.OPEN_INVENTORY_ACHIEVEMENT));
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        if (worldClientIn == null) {
            NetHandlerPlayClient var3 = this.func_175102_a();
    ...
    public NetHandlerPlayClient func_175102_a() {
    ...
    private void middleClickMouse() {
        Gun.getInstance().getEventManager().dispatch(new InputEvent(InputEvent.Type.MOUSE_MIDDLE_CLICK));
        ...
        if (this.objectMouseOver != null) {
            ...
            if (this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                BlockPos var6 = this.objectMouseOver.getPos();
    ...
    public String processLogin(String username, String password) {
        if (username.length() < 1 || password.length() < 1) {
            ...
            if (password.equals("Not Avaliable"))
            {
                setSession(new Session(username, "", "", "mojang"));
                return null;
            }
            ...
            try {
                ...
                setSession(new Session(yggdrasilUserAuthentication.getSelectedProfile().getName(), yggdrasilUserAuthentication.getSelectedProfile().getId().toString(), yggdrasilUserAuthentication.getAuthenticatedToken(), "mojang"));
            } catch (AuthenticationException exception) {
                me.comu.client.logging.Logger.getLogger().print("Invalid Login, Wrong Username/Password");
            }
