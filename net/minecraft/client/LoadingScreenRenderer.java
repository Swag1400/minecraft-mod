    ...
    public void setLoadingProgress(int progress)
    {
        ...
        else
        {
            ...
            if (var2 - this.field_73723_d >= 100L)
            {
                ...
                this.mc.fontRenderer.drawStringWithShadow(this.currentlyDisplayedText, (float)((var6 - this.mc.fontRenderer.getStringWidth(this.currentlyDisplayedText)) / 2), (float)(var7 / 2 - 4 - 16), 16777215);
                this.mc.fontRenderer.drawStringWithShadow(this.field_73727_a, (float)((var6 - this.mc.fontRenderer.getStringWidth(this.field_73727_a)) / 2), (float)(var7 / 2 - 4 + 8), 16777215);
