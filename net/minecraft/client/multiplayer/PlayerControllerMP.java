...
public class PlayerControllerMP
{
    ...
    public boolean func_180512_c(BlockPos p_180512_1_, EnumFacing p_180512_2_)
    {
        ...
        Gun.getInstance().getEventManager().dispatch(blockClickedEvent);
    ...
    {
   // 	final AttackEntityEvent aee = new AttackEntityEvent(targetEntity);
    //	Gun.getInstance().getEventManager().dispatch(aee);
   //if (aee.isCancelled()) {
    //		return;
    	//}
        this.syncCurrentPlayItem();
     ...
     */
    public ItemStack windowClick(int windowId, int slotId, int mouseButton, int clickType, EntityPlayer playerIn)
    {
        short var6 = playerIn.openContainer.getNextTransactionID(playerIn.inventory);
        ItemStack var7 = playerIn.openContainer.slotClick(slotId, mouseButton, clickType, playerIn);
        this.netClientHandler.addToSendQueue(new C0EPacketClickWindow(windowId, slotId, mouseButton, clickType, var7, var6));
        return var7;
    }
