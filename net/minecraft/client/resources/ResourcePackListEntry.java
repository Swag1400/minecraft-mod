...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        var10 = this.field_148317_a.fontRenderer.getStringWidth(var13);

        if (var10 > 157)
        {
            var13 = this.field_148317_a.fontRenderer.trimStringToWidth(var13, 157 - this.field_148317_a.fontRenderer.getStringWidth("...")) + "...";
        }

        this.field_148317_a.fontRenderer.drawStringWithShadow(var13, (float)(x + 32 + 2), (float)(y + 1), 16777215);
        List var11 = this.field_148317_a.fontRenderer.listFormattedStringToWidth(this.func_148311_a(), 157);

        for (int var12 = 0; var12 < 2 && var12 < var11.size(); ++var12)
        {
            this.field_148317_a.fontRenderer.drawStringWithShadow((String) var11.get(var12), (float)(x + 32 + 2), (float)(y + 12 + 10 * var12), 8421504);
        }
    }
