...
public class RenderEntityItem extends Render
{
    ...
    private int func_177077_a(EntityItem p_177077_1_, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_)
    {
        ...
        if (var11 == null)
        {
            ...
            if ((boolean)itemPhysics.getValue()) {
                ...
                boolean original = this.renderManager.options.fancyGraphics;
                if (!(var11 instanceof net.minecraft.item.ItemBlock)) {
                ...
                this.renderManager.options.fancyGraphics = original;
                if (!var12) {
    ...
    {
        RenderGameOverlayEvent renderGameOverlayEvent = new RenderGameOverlayEvent(p_177075_1_);
        Gun.getInstance().getEventManager().dispatch(renderGameOverlayEvent);

        if (renderGameOverlayEvent.isCancelled())
        {
            return;
        }

        ItemStack var10 = renderGameOverlayEvent.getEntityItem().getEntityItem();
