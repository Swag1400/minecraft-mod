...
public class LayerCape implements LayerRenderer
{
    ...
    public void doRenderLayer(AbstractClientPlayer p_177166_1_, float p_177166_2_, float p_177166_3_, float p_177166_4_, float p_177166_5_, float p_177166_6_, float p_177166_7_, float p_177166_8_)
    {
        ...
        if ((p_177166_1_.hasCape() || (clientCapes.isRunning()) && p_177166_1_.getGameProfile().getName().equals(Minecraft.getMinecraft().thePlayer.getName())) && !p_177166_1_.isInvisible() && p_177166_1_.func_175148_a(EnumPlayerModelParts.CAPE) && p_177166_1_.getLocationCape() != null)
        {
