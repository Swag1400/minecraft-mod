...
public class BlockModelRenderer
{
    ...
    {
        BlockRendererEvent blockRendererEvent = new BlockRendererEvent(blockStateIn.getBlock(), blockPosIn);
        Gun.getInstance().getEventManager().dispatch(blockRendererEvent);
        AntiLagEvent antiLagEvent = new AntiLagEvent();
        Gun.getInstance().getEventManager().dispatch(antiLagEvent);
        if (antiLagEvent.isPiston())
        {
            Block block = Minecraft.getMinecraft().theWorld.getBlockState(blockPosIn).getBlock();
