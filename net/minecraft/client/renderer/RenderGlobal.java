...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener
{
    ...
    public void func_180446_a(Entity p_180446_1_, ICamera p_180446_2_, float partialTicks)
    {
        ...
        else
        {
            ...
            TileEntityRendererDispatcher.instance.func_178470_a(this.theWorld, this.mc.getTextureManager(), this.mc.fontRenderer, this.mc.getRenderViewEntity(), partialTicks);
            this.field_175010_j.func_180597_a(this.theWorld, this.mc.fontRenderer, this.mc.getRenderViewEntity(), this.mc.pointedEntity, this.mc.gameSettings, partialTicks);
    ...
    public void drawSelectionBox(EntityPlayer p_72731_1_, MovingObjectPosition p_72731_2_, int p_72731_3_, float p_72731_4_)
    {
        if (p_72731_3_ == 0 && p_72731_2_.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
        {
            ...
            GlStateManager.depthMask(false);
            float var5 = 0.002F;
            BlockPos var6 = p_72731_2_.getPos();
