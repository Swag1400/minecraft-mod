...
public class TileEntityEnderChestRenderer extends TileEntitySpecialRenderer
{
    ...
    {
        RenderChestEvent renderChestEvent = new RenderChestEvent(RenderChestEvent.Time.BEFORE);
        Gun.getInstance().getEventManager().dispatch(renderChestEvent);
        this.func_180540_a((TileEntityEnderChest) p_180535_1_, p_180535_2_, p_180535_4_, p_180535_6_, p_180535_8_, p_180535_9_);
        RenderChestEvent renderChest2Event = new RenderChestEvent(RenderChestEvent.Time.AFTER);
        Gun.getInstance().getEventManager().dispatch(renderChest2Event);
    }
}
