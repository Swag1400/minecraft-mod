...
public class ItemRenderer
{
    ...
    public static boolean hitAnimation;
    public static float blockHeigh = -0.2F;
    ...
    public void renderItemInFirstPerson(float p_78440_1_)
    {
        ...
        Property hitAnimationProperty = renderModule.getPropertyByAlias("hitanimation");
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (var3.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.SwitchEnumAction.field_178094_a[var7.ordinal()])
                {
                    ...
                    case 4:
                        if (blockAnimation) {
                            EnumProperty blockMode = (EnumProperty) renderModule.getPropertyByAlias("blockmode");
                            if (blockMode.getValue() == me.comu.client.module.impl.active.render.Render.BlockMode.SWEEP) {
                                avatar(var2, var4);
                                func_178103_d();
                            } else if (blockMode.getValue() == me.comu.client.module.impl.active.render.Render.BlockMode.TAP) {
                                tap(var2, var4);
                                func_178103_d();
                            } else if (blockMode.getValue() == me.comu.client.module.impl.active.render.Render.BlockMode.VANILLA) {
                                func_178096_b(var2 - 0.0F, var4);
                                func_178103_d();
                                if (var7 != EnumAction.BLOCK)
                                    break;
                                GL11.glTranslatef(-0.5F, -0.2F, 0.0F);
                                GL11.glRotatef(10.0F, 50.0F, 0.0F, 1.0F);
            ...
            } else if ((Boolean)hitAnimationProperty.getValue())
            {
                func_178096_b(var2 * 0.5F, var4);
            }
            else
            {
    ...
    {
        RenderGameOverlayEvent renderGameOverlayEvent = new RenderGameOverlayEvent(RenderGameOverlayEvent.Type.FIRE);
